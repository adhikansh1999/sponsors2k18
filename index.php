...
<head>
  ...
  <link href="./sponsors_files/sf_logo.png" rel="icon" type="image/x-icon">
    ...
    <title>Sponsors| Spring Fest 2018</title>
</head>
...
<body id="page-top">		
    ...
    padding-bottom: 0px;">
                ...
                <a class="navbar-brand" href="https://springfest.in/sponsors/#page-top"><h6>Sponsors: Spring Fest</h6></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-5">
                    ...
                    <ul class="navbar-nav ml-auto nav-flex-icons">
                        ...
                        <li class="nav-item">
			              <a class="nav-link js-scroll-trigger" onclick="changeyear(2018);"><i class="fa fa-calendar"></i>2018</a>
			            </li>
			            <li class="nav-item">
			              <a class="nav-link" onclick="changeyear(2017);"><i class="fa fa-calendar"></i>2017</a>
			            </li>
			            <li class="nav-item">
			              <a class="nav-link" onclick="changeyear(2016);"><i class="fa fa-calendar"></i>2016</a>
			            </li>
			            <li class="nav-item">
			              <a class="nav-link" onclick="changeyear(2015);"><i class="fa fa-calendar"></i>2015</a>
			            </li>
			            <li class="nav-item">
			              <a class="nav-link" onclick="changeyear(2014);"><i class="fa fa-calendar"></i>2014</a>
			            </li>
			            <li class="nav-item">
			              <a class="nav-link" onclick="changeyear(2013);"><i class="fa fa-calendar"></i>2013</a>
			            </li>
                    </ul>
                    <!-- <ul class="navbar-nav ml-auto nav-flex-icons">
                        <li class="nav-item">
              ...
              <div class="col-sm-4 col-6">
                <div class="team-member">
                  ...
                  <ul class="list-inline social-buttons">
                    ...
                    <li class="list-inline-item">
                      <a href="https://www.linkedin.com/in/shreyash-gupta-422660148/">
              ...
              <div class="col-sm-4 col-6">
                <div class="team-member">
                  ...
                  <ul class="list-inline social-buttons">
                    ...
                    <li class="list-inline-item">
                      <a href="https://www.linkedin.com/in/hritik-khetan-37b84312b/">
                        <i class="fa fa-linkedin"></i>
                      </a>
                    </li>
                  </ul>
              ...
              <div class="col-sm-4 col-6">
                <div class="team-member">
                  ...
                  <ul class="list-inline social-buttons">
                    ...
                    <li class="list-inline-item">
                      <a href="https://www.linkedin.com/in/shreyansh-shah-97b89a147/">
                        <i class="fa fa-linkedin"></i>
                      </a>
                    </li>
                  </ul>
			  ...
			  <div class="col-sm-4 offset-sm-2 col-6">
                <div class="team-member">
                  ...
                  <ul class="list-inline social-buttons">
                    ...
                    <li class="list-inline-item">
                      <a href="https://www.linkedin.com/in/nishi-bajaj-a32530148/">
                        <i class="fa fa-linkedin"></i>
                      </a>
                    </li>
                  </ul>
           ...
           <div class="col-sm-4 col-6 offset-3 offset-sm-0">
                <div class="team-member">
                  ...
                  <ul class="list-inline social-buttons">
                    ...
                    <li class="list-inline-item">
                      <a href="https://www.linkedin.com/in/vitthal-agarwal-371516148/">
                        <i class="fa fa-linkedin"></i>
                      </a>
                    </li>
                  </ul>
	...
	<section id="partners">
		<div id="list_sponsors" class="container">
